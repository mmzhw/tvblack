...
import style from './LayoutMenus.css';
                                        ...
                                        return (
                                            <div key={item.id}>
                                                <Button type='default'
                                                    ...
                                                    className={style['topic-btn']}
                                                    onClick={this.props.changeMenuItem.bind(null, index)} className={style[this.props.curMenuIndex === index ? 'current-button' : '']}>{item.menuName}</Button>
                                            </div>
                                        );
                                    })
                                }
